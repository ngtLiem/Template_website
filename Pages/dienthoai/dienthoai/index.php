        ...
        <div id="footer">
            ...
            <div id="bg-footer">
                <div id="noidungfooter">
                    ...
                    <div id="noidung">
                        <ul>
                            <li><span id="tencongty">Cửa hàng điện thoại Hùng Lâm</span></li> <br>
                            <li>Địa chỉ: Tư Nghĩa - Quảng Ngãi</li>
                            <li>Điện thoại: 0355241806 - Hotline: 0355241806</li>
                            <li>Email: zens99x@gmail.com</li>
                        </ul>
                    </div>
                    <!-- End .noidung -->
                    <div id="thanhngang">
                    ...
                    <!-- End .thanhngang -->
                    <div id="copyright">
                        <a href="https://www.facebook.com/zens99x" target="_blank"><i class="fab fa-facebook-square"></i>/HungLamMobile</a>
                    </div>
                    <div id="copyright">
                    <a><i class="fas fa-phone-alt"></i> 0355241806</a>
                    </div>
                    <div id="copyright">
