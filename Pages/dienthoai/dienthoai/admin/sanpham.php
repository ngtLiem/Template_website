...
<div class="quanlysp">
	...
	<form action="admin.php?admin=xulysp" method="post">
		<div id="checksp">
			<a href='?admin=themsp' >Thêm sản phẩm</a>
		</div>
...
?>
            <tr class='noidung_hienthi_sp'>
                ...
                <td class="active_hienthi_sp">
					<a href='admin.php?admin=suasp&idsp=<?php echo $bien['idsp']  ?>'><img src="img/sua1.png" title="Sửa"></a>
...
?>
	...
	<?php
			...
			if($page < $total_pages){  
			$next = ($page + 1);  
			echo "<a href=\"".$_SERVER['PHP_SELF']."?admin=hienthisp&page=$next\"><button class='trang'>></button></a>";  
			}  
			echo "</center>";  		
