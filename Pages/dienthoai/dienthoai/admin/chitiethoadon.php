...
<?php 
	...
	?>
		<tr>
			<td colspan=6 align="right" style="padding:10px 20px 10px 0px; font-size:20px;"> <font color="red"><?php echo number_format($tong,0,",",".") ?></font></td>
		</tr>
	<?php 
	}
...
<div id="inhoadon">
	<p style="float:right; margin-top:10px; padding-right:30px; text-decoration: none;"><i class="fas fa-print"><a href="inhd.php?mahd=<?=$_GET['mahd']?>" target="_blank"> In hoá đơn</a></i></p>
</div>
