...
<div class="hoadon">
	<form action="index.php?content=xulyhd" method="post">
		<div id="checkhd">
			<p>
...
?>
            <tr class='noidung_hienthi_sp'>
				...
				<td class="active_hienthi_sp" style="width:70px;"><a href="index.php?content=chitiethoadon&mahd=<?php echo $bien['mahd']; ?> "><?php echo "Xem" ?> <i class="fas fa-search"></i></a>
				</td>
            </tr>
<?php 
    }
