...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url() ?>">
  <div class="sidebar-brand-icon rotate-n-15">
    ...
    <img src="<?php echo base_url().$_SESSION['system']['logo'] ?>" width="60px" heigth="60px" alt="">
  </div>
  <div class="sidebar-brand-text mx-3"><?php echo substr($_SESSION['system']['name'], 0,10) ?> <sup></sup></div>
</a>
...
<li class="nav-item <?php echo $product ?>  admin_only" >
  ...
  <div id="products_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item anc"  href="<?php echo base_url().'products/product_list' ?>">Product List</a>
      <a class="collapse-item anc"  href="<?php echo base_url().'products/product_type' ?>">Product Category</a>
    </div>
  </div>
</li>
<!-- Divider -->
