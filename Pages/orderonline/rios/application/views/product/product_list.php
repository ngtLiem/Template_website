         ...
         <div class="card mb-4 text-white bg-dark">
            ...
            <div class="card-body">
               ...
               <div class="pull-right">
              	...
              	<a href="javascript:void(0)" class="btn btn-outline-light btn-sm remove_prod">Delete</a>
               </div>
            </div>
         </div>
    </div>
...
<script>
    $(document).ready(function(){
        $('#new_prod').click(function(){
            AjaxUniModal(50,'<?php echo base_url().'popup/show_data/product/manage_product/add' ?>','Add new product')
        })
        load_pg();
            ...
            success:function(resp){
                if(resp){
                    ...
                    $('#list_holder .edit_prod').each(function(){
                        $(this).click(function(){
                            AjaxUniModal(50,'<?php echo base_url().'popup/show_data/product/manage_product/edit/' ?>'+$(this).attr('data-id'),'Edit Product');
                        })
                    })
                }
