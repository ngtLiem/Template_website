...
<head>
  ...
  <title>Calle Luna - <?php echo $page_title ?></title>
              ...
              if(typeof Data !=undefined && typeof Data != null){
               ...
               if(Data.type == 'order_update'){
                   if($('.order-list[data-id="'+Data.id+'"]').length > 0){
                       var badge = $('.order-list[data-id="'+Data.id+'"]').remove()
                   }
               }
               if(Data.type == 'delivery_update' && Data.user_id == '<?php echo $_SESSION['user_id'] ?>'){
                 if($.isFunction(window.load_orders))
                 load_orders(Data.id)
               }
