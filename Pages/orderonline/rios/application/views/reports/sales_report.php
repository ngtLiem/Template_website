...
<div class="col-md-12">
    <div class="row form-group justify-content-start align-items-center">
            <label for="date_start" class="control-label mr-1">Date Start :</label>
            <input type="text" class="form-control form-control-sm datepick_input col-md-3" id="date_start" value="<?php echo date("Y-m-d") ?>">
            <label for="date_start" class="control-label mx-1">End Date :</label>
            <input type="text" class="form-control form-control-sm datepick_input col-md-3" id="end_date" value="<?php echo date("Y-m-d") ?>">
        <div class="col-md-3">
        <button class="btn btn-primary btn-sm" id="filter_order" onclick="load_report()">Filter</button>
        <button class="btn btn-primary btn-sm" id="export_report"><i class="fa fa-file-excel"></i> Export to Excel</button>
        </div>
    </div>
    <hr>
    <div class="row">
