...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<!-- Quickview -->
		<link rel="alternate stylesheet" type="text/css" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/quickview/css/fancybox.css" media="screen" />
		<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/quickview/css/quickview.css" type="text/css" />
        <link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/quickview/css/fancybox.css" type="text/css" />               
		<script type="text/javascript" src="{NV_BASE_SITEURL}themes/{TEMPLATE}/quickview/js/jquery.fancybox.js"></script>
		<script type="text/javascript" src="{NV_BASE_SITEURL}themes/{TEMPLATE}/quickview/js/jquery.fancybox.function.js"></script>
		 <!-- end -->
    </head>
    <body>
    <noscript>
        ...
        <div class="wrapper">
            ...
            <div class="header">
                <div class="logo">
					<h1><a title="{THEME_LOGO_TITLE}" href="{THEME_SITE_HREF}"><img src="{LOGO_SRC}" alt="{THEME_LOGO_TITLE}" height="84" width="300"/></a></h1>
                </div>
                <div class="topadv">
                    [TOPADV]
                </div>
