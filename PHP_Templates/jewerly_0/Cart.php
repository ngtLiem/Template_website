...
<div class="text">
  ...
  <button id="buttontwo"> Subscribe </button>
            ...
            <?php
            // SELECT `Iid`, `Iweight`, `Itype`, `Icategory`, `no_of_items`, `date`, `pro_image`, `price` FROM `itemdetails` WHERE 1
                  ...
                  <form method="post"  action="Cart.php?action=add&id=<?php echo $row["Iid"]; ?>">
                    ...
                    <div class="product col-sm-6/2">
                      <div class="zoomImage">
                        ...
                        <a href="index4.php">
                          <img class="pic" src="<?php echo $row["pro_image"]; ?>" class="img-responsive" height="200px" width="200px">
                            <img class="picbig" src="<?php echo $row["pro_image"]; ?>" class="img-responsive" height="200px" width="200px">
                        </a>
